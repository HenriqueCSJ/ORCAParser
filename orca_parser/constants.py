"""
Physical constants and reference data for ORCA output parsing.
"""

# Standard atomic weights (IUPAC 2021 recommended values).
# For elements with no stable isotopes the mass of the longest-lived
# isotope is listed in parentheses in the IUPAC table; here we store
# the conventional value used by most quantum-chemistry codes.
ATOMIC_MASSES = {
    ...
    "Rf": 267.0,       "Db": 268.0,       "Sg": 271.0,      "Bh": 272.0,
    "Hs": 270.0,       "Mt": 276.0,       "Ds": 281.0,      "Rg": 280.0,
